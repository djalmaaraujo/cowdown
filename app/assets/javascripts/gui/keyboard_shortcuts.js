(function () {
  var fakeTabEvent = { currentTarget: document.getElementById('cowdown-textarea'), keyCode: 9 };
  var fakeGuiEvent = { preventDefault: function () {} };

  var KeyboardShortCuts = function () {
    this.listen();
  };

  KeyboardShortCuts.prototype.listen = function () {
